      ...
      body: SafeArea(
        child: Container(
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/images/loginPage_bg.png'),
              fit: BoxFit.cover,
            ),
          ),
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(30, 60, 30, 60), // Padding inside the container
                ...
                child: Column(
                  children: [
                    ...
                    TextField(
                      style: const TextStyle(fontSize: 15, color: Color(0xFF8F8F8F) ),
                      decoration: InputDecoration(
                        filled: true,
                        fillColor: const Color(0xFFF1F1F1),
                        contentPadding:
                            const EdgeInsets.symmetric(vertical: 12.0, horizontal: 12.0), // Adjusted padding
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(9.0), // Rounded corners
                          borderSide: BorderSide.none, // No border side for better appearance
                        ),
        ...
        // Action when pressed for Cancel
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        padding: const EdgeInsets.symmetric(vertical: 20.0, horizontal: 52.0), // Padding
